...
session = TembooSession(serge68, Jacquelin Jolly attempt #1, af90a2b17c0449d79f91337b744ff080)
...
uploadFileInputs.set_AccessToken(v5cwplndifznqzb1)
uploadFileInputs.set_FileName(str(sys.argv[1]))
uploadFileInputs.set_AccessTokenSecret(0kg1wypnpgkgbgm)
